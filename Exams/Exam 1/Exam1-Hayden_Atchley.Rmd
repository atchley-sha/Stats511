...
With the outliers greater than `r cutoff` removed, the results are now significant at an $\alpha = 0.05$ level. Considering this and that the log-transformed data also showed a significant difference, I'm inclined to interpret the extreme outliers as erroneous. However, a more thorough investigation into the cause and validity of these outliers would be wise.
